      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {services.map((service, i) => (
            <div
              key={service.title}
              className="reveal group relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm hover:shadow-2xl hover:border-primary/30 hover:scale-[1.03] transition-all duration-400 card-glow"
            ...
            >
              ...
              <a
                href="#booking"
                className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-primary-light px-4 py-2 text-xs font-semibold text-primary hover:bg-primary hover:text-white transition-all duration-300"
              >
                Book Now
